...
int main(int argc, char** argv) {
  ...
  // init_matrix << -0.41959, 0.0438648, 0.906653, 4.21508,
  //                0.0417586, 0.998707, -0.0289929, -0.434254,
  //               -0.906753, 0.0256955, -0.420879, 211.665,
  //                0.0, 0.0, 0.0, 1.0;
  // 복도 환경 초기정렬
  init_matrix << 0.966747939587, 0.056083124131, -0.249505370855, -5.257636547089,
                 0.150951087475, 0.662406623363,  0.733778297901,  2.623454332352,
                 0.206426575780, -0.747041881084,  0.631914615631,  4.490087985992,
                 0.0,             0.0,              0.0,             1.0;
