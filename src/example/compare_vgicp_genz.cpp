...
int main(int argc, char** argv) {
  ...
  genz_factor_setting.use_combined_cov = false;
  // 평면성 임계값 설정
  ...
  genz_vgicp.criteria.translation_eps = 1e-3;
  ...
  genz_vgicp.rejector.max_dist_sq =  vgicp_setting.max_correspondence_distance * vgicp_setting.max_correspondence_distance;
  ...
  // // kitti 0 ~ 400
  // init_matrix << 0.999995946884, 0.002785421442, 0.000430414890, -2.049128323793,
  //               -0.002782338765, 0.999971508980, -0.007004556712, 2.834670901299,
  //               -0.000449913263, 0.007003332023, 0.999975383282, -0.086760424078,
  //               0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000;
              // // 실제
              // 0.999995946884, 0.002785421442, 0.000430414890, -2.049128323793,
              // -0.002782338765, 0.999971508980, -0.007004556712, 2.834670901299,
              // -0.000449913263, 0.007003332023, 0.999975383282, -0.086760424078,
              // 0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000;

  // 복도 ground truth
  init_matrix << 0.999845802784, -0.010070090182, -0.014392176643, 0.315872490406,
                0.010524990037, 0.999435901642, 0.031889241189, -1.099993109703,
                0.014062931761, -0.032035805285, 0.999387621880, -0.388353943825,
                0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000;

// 차이가 조금 생길때
// 0.999662995338, -0.00520161818, -0.025433182716, 0.484208017588,
// 0.005615883507, 0.999852418900, 0.016244288534, -2.911702156067,
// 0.025344910100, -0.016381647438, 0.999544680119, -0.390953332186,
// 0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000;
